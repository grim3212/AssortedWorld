...
public final class WorldConfig {
	...
	public static class Common {
		...
		public final ForgeConfigSpec.IntValue spireTries;
		...
		public Common(ForgeConfigSpec.Builder builder) {
			...
			spireTries = builder.comment("Set this to how many tries should happen for a spire to generate.").defineInRange("spireTries", 5, 0, 36);
