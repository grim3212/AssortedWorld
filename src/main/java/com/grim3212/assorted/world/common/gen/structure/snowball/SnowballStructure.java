...
public class SnowballStructure extends StructureFeature<NoneFeatureConfiguration> {

	public SnowballStructure(Codec<NoneFeatureConfiguration> codec) {
		super(codec);
	}
